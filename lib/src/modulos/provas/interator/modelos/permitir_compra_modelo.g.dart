...
PermitirCompraModelo _$PermitirCompraModeloFromJson(
        Map<String, dynamic> json) =>
    PermitirCompraModelo(
      ...
      competidoresJaSelecionados:
          (json['competidoresJaSelecionados'] as List<dynamic>?)
              ?.map((e) => CompetidoresModelo2.fromJson(e as String))
              .toList(),
      idCabeceiraInvalido: json['idCabeceiraInvalido'] as String?,
    );

Map<String, dynamic> _$PermitirCompraModeloToJson(
        PermitirCompraModelo instance) =>
    <String, dynamic>{
