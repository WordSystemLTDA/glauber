...
part of 'competidores_modelo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CompetidoresModelo _$CompetidoresModeloFromJson(Map<String, dynamic> json) =>
    CompetidoresModelo(
...
Map<String, dynamic> _$CompetidoresModeloToJson(CompetidoresModelo instance) =>
    <String, dynamic>{
      'id': instance.id,
      'nome': instance.nome,
