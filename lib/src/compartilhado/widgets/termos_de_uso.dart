              ...
              child: Text.rich(
                ...
                TextSpan(
                  children: [
                    ...
                    const TextSpan(text: 'Se você não concorda com estes Termos, por favor não utilize os Serviços.\n\n'),
                    const TextSpan(
                      text:
                    ...
                    const TextSpan(text: "- Limite de compra por Usuário: até ingressos para cada dia de evento.\n"),
                    const TextSpan(
                        text:
                    ...
                    const TextSpan(text: '- O valor referente à taxa administrativa não será devolvido.\n'),
                    const TextSpan(
                        text:
