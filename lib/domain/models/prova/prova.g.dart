...
ProvaModelo _$ProvaModeloFromJson(Map<String, dynamic> json) => ProvaModelo(
      ...
      permitirCompra: PermitirCompraModelo.fromJson(json['permitirCompra'] as Map<String, dynamic>),
      ...
      animalSelecionado: json['animalSelecionado'] == null ? null : ModeloAnimal.fromJson(json['animalSelecionado'] as Map<String, dynamic>),
      nomeCabeceira: json['nomeCabeceira'] as String?,
      idCabeceira: json['idCabeceira'] as String?,
      competidores: (json['competidores'] as List<dynamic>?)?.map((e) => CompetidoresModelo.fromJson(e as Map<String, dynamic>)).toList(),
      idmodalidade: json['idmodalidade'] as String?,
    );

Map<String, dynamic> _$ProvaModeloToJson(ProvaModelo instance) => <String, dynamic>{
      'id': instance.id,
